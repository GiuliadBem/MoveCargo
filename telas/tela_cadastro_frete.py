...
class TelaCadastroFrete:
    ...
    def pega_dados_cadastro(self, lista_caminhoneiros, lista_caminhoes, frete=None):
        ...
        layout = [
            ...
            [sg.Text("Origem:", size=(20, 1)), sg.InputText(key="origem", default_text=valores_padrao["origem"])],
            [sg.Text("Destino:", size=(20, 1)), sg.InputText(key="destino", default_text=valores_padrao["destino"])],
            [sg.Text("Distância (km):", size=(20, 1)), sg.InputText(key="distancia", default_text=str(valores_padrao["distancia"]))],
            [sg.Text("Status:", size=(20, 1)), sg.Combo(status_opcoes, default_value=valores_padrao["status"], key="status", size=(18, 1))],
            [sg.Text("Caminhoneiro:", size=(20, 1)), sg.Combo(caminhoneiro_opcoes, default_value=valores_padrao["caminhoneiro"], key="caminhoneiro", size=(30, 1))],
            [sg.Text("Caminhão:", size=(20, 1)), sg.Combo(caminhao_opcoes, default_value=valores_padrao["caminhao"], key="caminhao", size=(30, 1))],
